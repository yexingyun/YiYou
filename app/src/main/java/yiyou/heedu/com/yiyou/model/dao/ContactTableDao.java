...
//        return users;
        ...
        while (cursor.moveToNext()){
            userInfo.setName(cursor.getString(cursor.getColumnIndex(ContactTable.COL_NAME)));
            userInfo.setPhoto(cursor.getString(cursor.getColumnIndex(ContactTable.COL_NICK)));
            userInfo.setNick(cursor.getString(cursor.getColumnIndex(ContactTable.COL_PHOTO)));
            userInfo.setHxid(cursor.getString(cursor.getColumnIndex(ContactTable.COL_HXID)));
